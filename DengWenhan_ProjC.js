...
eyex = 9.983968209769511 
eyey = 0.0
eyez = 5.990380925861705
lookatx = 2.7495688609363165
lookaty = 0
lookatz = 1.6497413165617896
rad = Math.sqrt((lookatx - eyex) * (lookatx - eyex) + (lookaty - eyey) * (lookaty - eyey));
theta = 3.15
var OB10 = document.getElementById("range10")
var L_PosLocR = OB10.value;
OB10.oninput = function() {
  if (ss == 1) {
    L_PosLocRt = this.value
  }
  else {
    L_PosLocR = this.value;
    console.log(L_PosLocR)
  }
} 
var OB11 = document.getElementById("range11")
var L_PosLocG = OB11.value;
OB11.oninput = function() {
  if (ss == 1) {
    L_PosLocGt = this.value
  }
  else {
    L_PosLocG  = this.value;
    console.log(L_PosLocG)
  }
} 
var OB12 = document.getElementById("range12")
var L_PosLocB = OB12.value;
OB12.oninput = function() {
  if (ss == 1) {
    L_PosLocBt = this.value
  }
  else {
    L_PosLocB = this.value;
    console.log(L_PosLocB)
  }
} 
var OB1 = document.getElementById("range1")
var L_AmbiLocR = OB1.value;
OB1.oninput = function() {
  if (ss == 1) {
    L_AmbiLocRt = this.value
  }
  else {
  L_AmbiLocR = this.value;
  }
} 
var OB2 = document.getElementById("range2")
var L_AmbiLocG = OB2.value;
OB2.oninput = function() {
  if (ss == 1) {
    L_AmbiLocGt = this.value
  }
  else {
  L_AmbiLocG = this.value;
  }
} 
var OB3 = document.getElementById("range3")
var L_AmbiLocB = OB3.value;
OB3.oninput = function() {
  if (ss == 1) {
    L_AmbiLocBt = this.value
  }
  else {
  L_AmbiLocB = this.value;
  }
} 
var OB4 = document.getElementById("range4")
var L_DiffLocR = OB4.value;
OB4.oninput = function() {
  if (ss == 1) {
    L_DiffLocRt = this.value
  }
  else {
    L_DiffLocR  = this.value;
  }
} 
var OB5 = document.getElementById("range5")
var L_DiffLocG = OB5.value;
OB5.oninput = function() {
  if (ss == 1) {
    L_DiffLocGt = this.value
  }
  else {
    L_DiffLocG  = this.value;
  }
} 
var OB6 = document.getElementById("range6")
var L_DiffLocB = OB6.value;
OB6.oninput = function() {
  if (ss == 1) {
    L_DiffLocBt = this.value
  }
  else {
    L_DiffLocB  = this.value;
  }
} 
var OB7 = document.getElementById("range7")
var L_SpecLocR = OB7.value;
OB7.oninput = function() {
  if (ss == 1) {
    L_SpecLocRt = this.value
  }
  else {
    L_SpecLocR  = this.value;
  }
} 
var OB8 = document.getElementById("range8")
var L_SpecLocG = OB8.value;
OB8.oninput = function() {
  if (ss == 1) {
    L_SpecLocGt = this.value
  }
  else {
    L_SpecLocG  = this.value;
  }
} 
var OB9 = document.getElementById("range9")
var L_SpecLocB = OB9.value;
OB9.oninput = function() {
  if (ss == 1) {
    L_SpecLocBt = this.value
  }
  else {
    L_SpecLocB  = this.value;
  }
} 
...
// Find new values for all time-varying parameters used for on-screen drawing
  ...
  if(g_posNow1 > g_posMax1) {   // above the max?
    ...
    g_angle04 = g_angle04 + (g_angle04Rate * elapsedMS) / 1000.0;
    ...
    switch(kev.code) {
      case "KeyP":
       if (ss == 0) {
        ...
        L_AmbiLocRt = L_AmbiLocR;
        L_AmbiLocGt = L_AmbiLocG;
        L_AmbiLocBt = L_AmbiLocB;
        L_DiffLocRt = L_DiffLocR;
        L_DiffLocGt = L_DiffLocG;
        L_DiffLocBt = L_DiffLocB;
        L_SpecLocRt = L_SpecLocR;
        L_SpecLocGt = L_SpecLocG;
        L_SpecLocBt = L_SpecLocB;
        L_PosLocGt = L_PosLocG;
        L_PosLocBt = L_PosLocB;
        L_PosLocRt = L_PosLocR;
        L_AmbiLocR = 0;
        L_AmbiLocG = 0;
        L_AmbiLocB = 0;
        L_DiffLocR = 0;
        ...
        ss = 0
        L_AmbiLocR = L_AmbiLocRt;
        L_AmbiLocG = L_AmbiLocGt;
        L_AmbiLocB = L_AmbiLocBt;
        L_DiffLocR = L_DiffLocRt;
        L_DiffLocG = L_DiffLocGt;
        L_DiffLocB = L_DiffLocBt;
        L_SpecLocR = L_SpecLocRt;
        L_SpecLocG = L_SpecLocGt;
        L_SpecLocB = L_SpecLocBt;
        L_PosLocG = L_PosLocGt;
        L_PosLocB = L_PosLocBt;
        L_PosLocR = L_PosLocRt;
      }
        break;
        case "KeyA":
        ...
        //	document.getElementById('KeyDownResult').innerHTML =
            ...
            lookatx -= 0.1 * Math.sin(theta);
            lookaty += 0.1 *  Math.cos(theta);
...
// ALL VBObox objects.  REPLACE This with your own camera-control code.
  ...
  g_cam.setIdentity();
	g_cam.perspective(30.0,   // FOVY: top-to-bottom vertical image angle, in degrees
  ...
  g_cam.lookAt(eyex, eyey, eyez,	// center of projection
